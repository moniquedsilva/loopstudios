<template>
  <header class="fixed w-full max-w-[1114px] flex p-6 transition-transition duration-300" :class="menuOpen ? 'h-screen bg-brand-black inset-0 items-start flex-col' : 'h-[105px] justify-between items-center'">
